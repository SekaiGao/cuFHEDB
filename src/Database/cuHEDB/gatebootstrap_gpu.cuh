...
cufhedb::cuCoreFHE<Lvl1, UNROLL> cufftlvl1(num_stream1);
cufhedb::cuCoreFHE<Lvl2> cufftlvl2(num_stream2);
...
void MSBGateBootstrapping(TFHEpp::TLWE<Lvl1> &res,
  ...
  cufftlvl1.GateBootstrapping_st(res, tlwelvl0, -u, stream_id);
  if (IS_ARITHMETIC(result_type))
    res[Lvl1::k * Lvl1::n] += u;
}
...
void MSBGateBootstrapping(TFHEpp::TLWE<Lvl2> &res,
  ...
  TFHEpp::TLWE<Lvl0> tlwelvl0;
  TFHEpp::IdentityKeySwitch<Lvl20>(tlwelvl0, tlweoffset, *ek.iksklvl20);
  cufftlvl2.GateBootstrapping_st(res, tlwelvl0, -u, stream_id);
  if (IS_ARITHMETIC(result_type))
    res[Lvl2::k * Lvl2::n] += u;
}
...
void IdeGateBootstrapping(TFHEpp::TLWE<Lvl1> &res,
  ...
  TFHEpp::TLWE<Lvl0> tlwelvl0;
  TFHEpp::IdentityKeySwitch<Lvl10>(tlwelvl0, tlweoffset, *ek.iksklvl10);
  cufftlvl1.IdeGateBootstrapping_st(res, tlwelvl0, scale_bits, stream_id);
}
...
void IdeGateBootstrapping(TFHEpp::TLWE<Lvl1> &res,
  ...
  TFHEpp::TLWE<Lvl0> tlwelvl0;
  TFHEpp::IdentityKeySwitch<Lvl20>(tlwelvl0, tlweoffset, *ek.iksklvl20);
  cufftlvl1.IdeGateBootstrapping_st(res, tlwelvl0, scale_bits - 32, stream_id);
}
...
void IdeGateBootstrapping(TFHEpp::TLWE<Lvl2> &res,
  ...
  TFHEpp::TLWE<Lvl0> tlwelvl0;
  TFHEpp::IdentityKeySwitch<Lvl20>(tlwelvl0, tlweoffset, *ek.iksklvl20);
  cufftlvl2.IdeGateBootstrapping_st(res, tlwelvl0, scale_bits, stream_id);
}
...
void HomAND(TLWELvl1 &res, const TLWELvl1 &ca, const TLWELvl1 &cb,
  ...
  cufftlvl1.GateBootstrapping_st(res, tlwelvl0, offset, stream_id);
  if (IS_ARITHMETIC(result_type))
...
void LOG_to_ARI(TLWELvl1 &res, const TLWELvl1 &tlwe, const TFHEEvalKey &ek, uint32_t stream_id) {
  ...
  cufftlvl1.GateBootstrapping_st(res, tlwelvl0, -μ, stream_id);
