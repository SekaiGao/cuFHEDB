...
struct lvl0param {
    ...
    static const inline double α = std::pow(2.0, -16);//0.000'092'511'997'467'675'6;  // fresh noise
...
struct lvl0param80 {
    ...
    static constexpr int32_t key_value_min = 0;
    static constexpr int32_t key_value_diff = key_value_max - key_value_min;
    static constexpr std::uint32_t n = 496;
    static constexpr std::uint32_t k = 1;
    static constexpr ErrorDistribution errordist = ErrorDistribution::ModularGaussian;
...
struct lvl01param80 {
    using domainP = lvl0param80;
    using targetP = lvl1param80;
};
